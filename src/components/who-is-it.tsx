...
type WhoIsItProps = { isNapo: boolean; isMary: boolean; faceCount: number; file: string };

const WhoIsIt: FC<WhoIsItProps> = ({ isNapo, isMary, faceCount, file }) => (
	<>
		<Typography variant="h4" align="center" fontSize="1.75rem" mt="1rem">
			{getHeading(isNapo, isMary, faceCount)}
		</Typography>
		<img loading="lazy" src={file} alt="uploaded file" style={{ display: "block", margin: "1rem auto", width: "50%" }} />
	</>
);
